...
class MobileNet2(nn.Module):
    def __init__(self, input_size=224, last_channel=320, width_mult=1., dilation=1, ratio=1):
        ...
        self.features.append(nn.Conv2d(self.last_channel, 2, 3, padding=1, bias=False)) # final
...
class MobileNet2Dilate2(MobileNet2):
    def __init__(self):
        MobileNet2.__init__(self, dilation=2)


class MobileNet2Dilate4(MobileNet2):
    def __init__(self):
        MobileNet2.__init__(self, dilation=4)


class MobileNet2Half(MobileNet2):
    def __init__(self):
        MobileNet2.__init__(self, ratio=1 / 2)


class MobileNet2Quarter(MobileNet2):
    def __init__(self):
        MobileNet2.__init__(self, ratio=1 / 4)
